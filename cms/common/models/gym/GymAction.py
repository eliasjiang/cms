...
class GymAction(db.Model):
    __tablename__ = 'gym_action'
    id = db.Column(db.Integer, primary_key=True, info='ID')
    name = db.Column(db.String(180), nullable=False, server_default=db.FetchedValue(), info='动作名称')
    ...
    category_id = db.Column(db.Integer, nullable=False, server_default=db.FetchedValue(), info='动作分类')
