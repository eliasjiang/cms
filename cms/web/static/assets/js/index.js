...
var groups = document.getElementsByClassName(".index_group");
var timer = setTimeout(function () {
  for (var i = 0, n = groups.length; i < n; i++) {
    groups[i].style.zIndex = 10;
  }
}, 2000);
var mySwiper = new core("#full-width-slider", {
  // simulateTouch : false,
  // onlyExternal:true,
  // mousewheelControl : true,
  resistance: "100%",
  onSlideChangeEnd: function onSlideChangeEnd(mySwiper) {
    //
    var charmaIndex = parseInt(mySwiper.activeIndex);
    var mimgs = document.querySelectorAll(".index_mouse img");
    console.dir(charmaIndex);
    if (charmaIndex == 1) {
      var mSpan = document.querySelector(".index_mouse span:nth-child(2)");
      mSpan.classList.add("bullet-active");
      var nSpans = siblingElems(mSpan);
      for (var _k = 0, u = nSpans.length; _k < u; _k++) {
        nSpans[_k].classList.remove("bullet-active");
      }
      for (var i = 0, n = mimgs.length; i < n; i++) {
        mimgs[k].setAttribute("src", "/static/assets/imgs/index_left_arrow.png");
      }
    } else if (charmaIndex == 0) {
      var _mSpan = document.querySelector(".index_mouse span:nth-child(1)");
      _mSpan.classList.add("bullet-active");
      var _nSpans = siblingElems(_mSpan);
      for (var _k2 = 0, _u = _nSpans.length; _k2 < _u; _k2++) {
        _nSpans[_k2].classList.remove("bullet-active");
      }
      for (var _i = 0, _n = mimgs.length; _i < _n; _i++) {
        mimgs[k].setAttribute("src", "/static/assets/imgs/index_right_arrow.png");
      }
    }
  }
});
...
var _loop = function _loop(i, n) {
  mimgs[i].addEventListener('click', function () {
    var img = mimgs[i].getAttribute("src");
    if (img === "/static/assets/imgs/index_left_arrow.png") {
      mySwiper.slideTo(0, 500, false);
      for (var _k3 = 0; _k3 < n; _k3++) {
        mimgs[_k3].setAttribute("src", "/static/assets/imgs/index_right_arrow.png");
      }
    } else {
      mySwiper.slideTo(1, 500, false);
      for (var _k4 = 0; _k4 < n; _k4++) {
        mimgs[_k4].setAttribute("src", "/static/assets/imgs/index_left_arrow.png");
      }
    }
  });
};
...
var mSpans = document.querySelectorAll(".index_mouse span");
var _loop2 = function _loop2(_i2, _n2) {
  var nSpans = siblingElems(mSpans[_i2]);
  mSpans[_i2].addEventListener('click', function () {
    mSpans[_i2].classList.add("bullet-active");
  });
  for (var _k5 = 0, u = nSpans.length; _k5 < u; _k5++) {
    nSpans[_k5].classList.remove("bullet-active");
  }
};
for (var _i2 = 0, _n2 = mSpans.length; _i2 < _n2; _i2++) {
  _loop2(_i2, _n2);
}
/******/ })()
;
