...
def grant_index():
    ...
    return UtilHelper.renderView("admin/rbac/grant/index.html", {
        "list": list,
        "pages": pages,
        "sc": sc,
        "set_flag": set_flag,
...
def grant_set():
    if UtilHelper.isGet() :
        ...
        if act == "copy" and info:
            info.id = 0
        return UtilHelper.renderPopView( "admin/rbac/grant/set.html",{ "info":info,"weight_list":weight_list, }  )
...
def grant_assign():
    if UtilHelper.isGet() :
        ...
        return UtilHelper.renderView("admin/rbac/grant/assign.html", {
            "list": action_data,
