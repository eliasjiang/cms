...
def log_access():
    ...
    return UtilHelper.renderView( "admin/log/access.html",{"list": list,"pages":pages,"sc":sc }  )
...
def log_error():
    ...
    return UtilHelper.renderView("admin/log/error.html", {"list": list, "pages": pages, "sc": sc})
