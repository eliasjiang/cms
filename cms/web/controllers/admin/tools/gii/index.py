...
def gii_index():
    return UtilHelper.renderView( "/admin/tools/gii/index.html"  )
...
def gii_model():
    ...
    if UtilHelper.isGet():
        ...
        table_list.sort()
        return UtilHelper.renderView( "/admin/tools/gii/model.html",{
...
def gii_job():
    ...
    if UtilHelper.isGet():
        ...
        return UtilHelper.renderView( "/admin/tools/gii/job.html",{
            "default_path_prefix":default_path_prefix
        })
...
def gii_service():
    ...
    if UtilHelper.isGet():
        return UtilHelper.renderView( "/admin/tools/gii/service.html",
              { "default_path_prefix":default_path_prefix })
